...
try:
    ...
    def _missing_structuregenerator(*_args, **_kwargs):
        raise ImportError(
            "缺少可选依赖 structuregenerator，请从其来源安装后重试 "
            "(parser_vasp 需要 structuregenerator.psolib.utils.uniq_atom_names)"
        ) from exc

    uniq_atom_names = _missing_structuregenerator
